...
const nodes = [
  ...
  { id: 'r21', label: 'Transfer Status', x: 250, y: 590 }, { id: 'r22', label: 'Payroll Transfer', x: 460, y: 700 }, { id: 'r23', label: 'Project Costing Transfer', x: 295, y: 700 }, { id: 'r24', label: 'Other External Uses', x: 80, y: 700 }
];
